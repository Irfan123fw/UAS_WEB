            ...
            <div class="main-panel">
                ...
                <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="anggota.php" method="POST" style="width: 1100px;">
                                    <div class="input-group mb-3" style="width: 400px;">
                                        <input type='text' class="form-control input-sm " style="width: 150px;"  name='qcari' placeholder='Cari berdasarkan User ID dan Username' required /> 
                  ...
                  <thead>
                    ...
                    <td><a href="detail-anggota.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="ti-user"></span> <?php echo $data['nama']; ?></a></td>
                    <td><?php echo $data['jk'];?></td>
                    <td><?php echo $data['kelas'];?></td>
                    <td><?php echo $data['ttl'];?></td>
                    <td><?php echo $data['alamat'];?></td>
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Anggota" href="edit-anggota.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-edit">Edit</span></a>
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Anggota" href="hapus-anggota.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash">Hapus</a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="anggota.php" class="btn btn-sm btn-info">Refresh Anggota <i class="ti-reload"></i></a> <a href="input-anggota.php" class="btn btn-sm btn-warning">Tambah Anggota <i class="ti-plus"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
