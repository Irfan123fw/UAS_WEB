...
<body>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-search d-none d-lg-block">
            ...
            <td align="left" width="30"> ,&nbsp&nbsp </td>
  ...
  <div class="container">
    <h1 class="display-4">Selamat Datang <span><b><?=$_SESSION['fullname'] ?> </b></span></h1>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="images/dashboard/perpus.jpg" alt="people">
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2 text-blue">
                        <!-- <h4 class="location font-weight-normal text-blue">Pekanbaru</h4>
