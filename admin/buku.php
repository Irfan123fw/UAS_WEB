        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="panel-body table-responsive">
                                    ...
                                    <form action="buku.php" method="POST" style="width: 1100px;">
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Buku" href="edit-buku.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-edit">Edit</span></a>
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['judul'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Buku" href="hapus-buku.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash">Hapus</a></center></td></tr></div>
              ...
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="buku.php" class="btn btn-sm btn-info">Refresh Buku <i class="ti-reload"></i></a> <a href="input-buku.php" class="btn btn-sm btn-warning">Tambah Buku <i class="ti-plus"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
