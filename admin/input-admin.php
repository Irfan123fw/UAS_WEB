                ...
                <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-admin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="user_id" type="text" style="width: 800px;"  id="user_id" class="form-control" placeholder="Tidak perlu di isi" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Username</label>
                              <div class="col-sm-8">
                                  <input name="username" type="text" style="width: 800px;" id="username" class="form-control" placeholder="Username" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="password" type="text" style="width: 800px;" id="password" class="form-control" placeholder="password" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Fullname</label>
                              <div class="col-sm-8">
                                  <input name="fullname" class="form-control" style="width: 800px;" id="fullname" type="text" placeholder="Fullname" required />
                              </div>
                          </div>
                          <div class="form-group">
