            ...
            <div class="main-panel">
                ...
                <div class="row">
                    ...
                    <td rowspan="9"><div class="pull-right image">
                            <img src="<?php echo $data['foto']; ?>" class="img-rounded"  alt="User Image" style="height:300px; width:300px; border: 3px solid #333333;" />
                        </div></td>
                    </tr>
                    <tr>
                ...
                <a href="anggota.php" class="btn btn-sm btn-warning"> Kembali </a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
