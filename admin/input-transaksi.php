                ...
                <div class="row">
                      ...
                      <form action="insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm">
                               <input type="text" id="pinjam" style="width: 800px;" name="pinjam" class="form-control" value="<?php echo $pinjam; ?>" readonly="readonly" >   
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Kembali</label>
                              <div class="col-sm">
                                  <input type="text" id="kembali" style="width: 800px;" name="kembali" class="form-control" value="<?php echo $kembali; ?>" readonly="readonly">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Kembali</label>
                              <div class="col-sm">
                                  <input type="text" id="keterangan" style="width: 800px;" name="keterangan" class="form-control" placeholder="Keterangan" required>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
