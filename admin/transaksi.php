            ...
            <div class="main-panel">
                ...
                <div class="row">
                  ...
                  $no=0;
                    ...
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Kembali" href="kembali.php?hal=edit&id_trans=<?php echo $data['id'];?>&judul=<?php echo $data['judul_buku'];?>"><span class="glyphicon glyphicon-tags">Kembali</span></a>
                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Perpanjang" href="perpanjang.php?hal=id_trans=<?php echo $data['id'];?>&judul=<?php echo $data['judul_buku'];?>&kembali=<?php echo $data['tgl_kembali'];?>&lambat=<?php $lambat; ?>"><span></span>Perpanjang</a>
                    </td></tr></div>
                    <?php   
              } 
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="transaksi.php" class="btn btn-sm btn-info">Refresh <i class="ti-reload"></i></a> </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
                    </div>
