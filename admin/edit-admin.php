            ...
            <div class="main-panel">
                ...
                <div class="row">
                    ...
                    ?>
                      ...
                      <form action="update-admin.php" method="post" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">User ID</label>
                              <div class="col-sm">
                                  <input name="user_id" type="text" id="user_id" style="width:800px;" class="form-control" value="<?php echo $data['user_id'];?>" readonly="readonly" autofocus="on" />
                              </div>
                          </div>
                          <div class="form-group">
