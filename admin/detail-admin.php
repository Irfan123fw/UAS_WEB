            ...
            <div class="main-panel">
                ...
                <div class="row">
                    ...
                    <td rowspan="9"><div class="pull-right image">
                            <img src="<?php echo $data['gambar']; ?>" class="img-rounded" alt="User Image" style=" height:300px; width:300px; border: 3px solid #333333;" />
                        </div></td>
                    </tr>
                    <tr>
                ...
                <a href="admin.php" class="btn btn-sm btn-warning"> Kembali </a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
