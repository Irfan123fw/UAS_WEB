...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di PerPusWeb (Perpustakaan Berbasis Website)  Untuk Login Admin silahkan klik Icon User atau klik <a href="login.php">disini</a></b>
          </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> PerPusWeb adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> PerPusWeb memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari PerPusWeb dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> PerPusWeb bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi494@gmail.com">PerPusWeb@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.PerPusWeb.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
